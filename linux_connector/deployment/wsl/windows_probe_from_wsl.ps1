# Invoke the Linux probe inside WSL while forwarding Windows-side media parameters safely.
param(
...
$cmd = "cd '$wslRepo' && chmod +x linux_connector/deployment/wsl/*.sh && ./linux_connector/deployment/wsl/probe_windows_lola.sh $quotedProbeArgs"
