...
private func preflightDeliverables(
    ...
    return [
        deliverable(
            ...
            audioEvidence,
            rmeBlockers(audio) + ["two-Mac bidirectional route evidence is not attached"]
        ),
        deliverable(
            .receiverSideRoutingMixing,
            "Receiver-side routing/mixing",
            audioEvidence,
            rmeBlockers(audio) + ["physical receiver-side RME receive/mix evidence is not attached"]
        ),
        deliverable(
        ...
        deliverable(
            ...
            audioEvidence + ["physical-route-report: not-attached", "sixty-minute-drift-plc-report: not-attached"],
            rmeBlockers(audio) + ["accepted physical route and long-run measurement reports are not attached"]
        ),
        deliverable(
            .rxBufferBenchmarks,
        ...
        deliverable(
            ...
            videoEvidence + ["staged-multi-video-runtime: available"],
            videoBlockers(video) + ["physical multi-source runtime evidence is not attached"]
        ),
        deliverable(
            .avTimingRealRuns,
        ...
        deliverable(
            ...
            signingEvidence + ["clean-mac-report: not-attached"],
            signingBlockers(signing) + ["notarization, Gatekeeper, and clean-Mac install evidence are not attached"]
        ),
    ]
}
