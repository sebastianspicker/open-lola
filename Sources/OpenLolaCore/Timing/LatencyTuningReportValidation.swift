...
extension LatencyTuningReport {
    ...
    private func validate(_ candidate: LatencyTuningCandidate) throws {
        ...
        try LatencyTuningValidator.requirePositive(candidate.audioMode.channelCount, "candidates.audioMode.channelCount")
        try LatencyTuningValidator.requireNonEmpty(candidate.audioMode.sampleFormat, "candidates.audioMode.sampleFormat")
...
private func validateLatencyTuningHardware(_ hardware: HardwareIdentity, prefix: String) throws {
...
private func validateLatencyTuningRoute(_ route: RouteIdentity, prefix: String) throws {
...
private func validateLatencyTuningTiming(
    _ timing: LatencyBenchmarkTimingMetrics,
    candidateId: String
) throws {
    try LatencyTuningValidator.requireNonNegative(timing.oneWayEstimateMicroseconds, "timing.oneWayEstimateMicroseconds")
...
private func validateLatencyTuningLoss(_ loss: LatencyBenchmarkLossMetrics) throws {
...
private func validateLatencyTuningFaults(_ faults: LatencyBenchmarkFaultMetrics) throws {
...
private func validateLatencyTuningResources(
    ...
    try LatencyTuningValidator.requireNonNegative(resources.residentMemoryMegabytes, "resources.residentMemoryMegabytes")
    guard timingPercentilesAreOrdered(
...
private func latencyTuningCandidateIsFaster(
...
private func requireLatencyTuningPercent(_ value: Double, _ field: String) throws {
