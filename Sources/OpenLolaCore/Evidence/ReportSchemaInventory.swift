...
public enum ReportSchemaInventory {
    ...
    public static let entries: [ReportSchemaInventoryEntry] = [
        ...
        schema("RealtimeAudioEngineReport", "realtime audio engine", .measured, "Sources/OpenLolaCore/Audio/Realtime/RealtimeAudioEngine.swift", validators: ["validate-realtime-audio-engine-report"], fixture: "RealtimeAudioEngineReports", smoke: "realtime-audio-synthetic-smoke", tests: ["Tests/OpenLolaCoreTests/RealtimeAudioEngineTests.swift"], measured: true, notes: "PASS rejects synthetic runs, callback allocation, unbounded handoff, and buffered playout targets."),
        ...
        schema("MacToMacConnectionEstablishmentReport", "Mac-to-Mac connection establishment", .sourceLevel, "Sources/OpenLolaCore/Network/P2P/MacToMacConnectionEstablishment.swift", validators: ["validate-mac-to-mac-connection-establishment-report"], tests: ["Tests/OpenLolaCoreTests/MacToMacConnectionEstablishmentTests.swift"], measured: false, notes: "Source-level setup contract for the IP/NAT-first default. PASS requires IP/NAT setup mode, passing diagnostics, passing NAT direct traversal evidence, direct UDP/IP selected route, no blockers, and no SSH or relay fallback."),
        ...
        schema("ReleaseHardeningReport", "release hardening", .cleanMac, "Sources/OpenLolaCore/Release/ReleaseHardening.swift", validators: ["validate-release-hardening-report"], fixture: "ReleaseHardeningReports", smoke: "release-hardening-synthetic-smoke", tests: ["Tests/OpenLolaCoreTests/ReleaseHardeningTests.swift"], measured: true, notes: "PASS requires measured reports, verification gates, public-doc audit, package PASS, signing PASS, clean-Mac PASS, and no remaining partial gates."),
        schema("OpenSourceReleaseReadinessReport", "open-source release readiness", .sourceLevel, "Sources/OpenLolaCore/Release/OpenSourceReleaseReadiness.swift", validators: ["validate-open-source-release-readiness-report"], fixture: "OpenSourceReleaseReadinessReports", tests: ["Tests/OpenLolaCoreTests/OpenSourceReleaseReadinessTests.swift"], measured: false, notes: "PASS requires final source and documentation licenses, final notices, fixture provenance, allowlist release staging, reviewer signoff, and public approval."),
...
private func schema(
    ...
    ReportSchemaInventoryEntry(
        ...
        falsePassFixtureCount: falsePassFixtureCount(for: fixture),
        notes: notes
    )
}
