extension FixtureSmokeMatrix {
    ...
    private static let syntheticValidationFixtureGroups: [FixtureMatrixEntry] = [
        ...
        fixture("ExternalConnectorSessionReports", 2, .syntheticValidationFixture, validator: "validate-external-connector-session-report", source: "Sources/OpenLolaCore/Connectors/Core/ExternalConnectorSession.swift", test: "Tests/OpenLolaCoreTests/ExternalConnectorSessionTests.swift", falsePass: ["external-connector-session-missing-media-pass.json"]),
        ...
        fixture("JackTripCompatibilityMediaReports", 1, .syntheticValidationFixture, source: "Sources/OpenLolaCore/Connectors/JackTrip/JackTripCompatibility.swift", test: "Tests/OpenLolaCoreTests/JackTripPassValidationTests.swift"),
        ...
        fixture("OpenSourceReleaseReadinessReports", 2, .syntheticValidationFixture, validator: "validate-open-source-release-readiness-report", source: "Sources/OpenLolaCore/Release/OpenSourceReleaseReadiness.swift", test: "Tests/OpenLolaCoreTests/OpenSourceReleaseReadinessTests.swift", falsePass: ["open-source-release-readiness-missing-requirement-pass.json"]),
        fixture("UltraGridCompatibilityMediaReports", 1, .syntheticValidationFixture, source: "Sources/OpenLolaCore/Connectors/UltraGrid/UltraGridCompatibility.swift", test: "Tests/OpenLolaCoreTests/UltraGridCompatibilityTests.swift"),
    ]
