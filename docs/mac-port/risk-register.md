...
Date: 2026-05-11
Status: active Mac-port risk register after docs/mac-port consolidation
Verdict: PARTIAL
...
| R011 | SOTA source drift may invalidate a milestone gate. | Open | Refresh primary sources before implementation and update the SOTA matrix first. | [sota-open-question-matrix.md](sota-open-question-matrix.md) row updated with dated source check. |
