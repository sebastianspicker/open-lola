...
- publication-safe research summaries under [../background/](../background/README.md).
...
[../compliance/README.md](../compliance/README.md). Compatibility parser or
packet work must also follow the release boundary in
[../compliance/release-manifest.md](../compliance/release-manifest.md).
...
Use [../background/publication-redactions.md](../background/publication-redactions.md)
as the redaction policy. Internal evidence remains outside the public release
surface and must not be linked from publication docs.
