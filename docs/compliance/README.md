...
This directory now has two active files:

| Document | Purpose |
|---|---|
| [README.md](README.md) | Compliance summary, active blockers, and reviewer handoff. |
...
- `.build/**`, `.swiftpm/**`, `DerivedData/**`,
  ...
  restored root `plan.md`, `plan-findings-ledger.md`, `plan-status.md`,
  `docs/review/**`,
  `docs/mac-port/reports/**`, `re_out/**`, generated outputs, captures,
